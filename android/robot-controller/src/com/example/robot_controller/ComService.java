...
public class ComService extends Service {
    ...
    private static ArrayList<Byte> mSavedData = new ArrayList();
    ...
    final static String GET_REQUEST = "primavera.arduino.intent.action.GET_REQUEST";
    final static String REQUEST_RESPONSE = "primavera.arduino.intent.action.REQUEST_RESPONSE";
    ...
    String getLastCommand() {
    	...
    	// Read from List<Byte> "mSavedData"
    	for (Byte b : mSavedData) {
    		if (b==0) {break;}
    ...
    BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("primavera.arduino.intent.action.GET_REQUEST".equals(action)){
                ArrayList<String> commandArray = new ArrayList();

                // Parse comments into ArrayList
                String temp = "";
                 for ( Byte buyet : mSavedData) {
                    if(buyet == 0) {
                        commandArray.add(temp);
                        temp = "";
                    }
                    else
